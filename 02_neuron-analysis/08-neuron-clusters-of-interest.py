...
## AnnData
data_dir = "/path/to/project/results/h5ad"
...
hvg_dir = "/path/to/project/results/de/neuron_cluster/cluster-markers"
...
## Save as csv
save_dir = "/path/to/project/results/de/neuron_cluster/cluster-markers"
