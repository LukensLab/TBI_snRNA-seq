...
# Figures outlines here are drafts from the initial submission.
...
data_dir = os.path.join(base_dir, "analysis", "3", "h5ad")
save_dir = os.path.join(base_dir, "analysis", "3", "results", "de", "cell_type")
