...
## Define paths
data_dir = '/path/to/project/analysis/2/de/cell_type/wald/pairwise-comps/size-factors'
...
save_path <- "/path/to/project/analysis/2/figures/wald/volcano-cell_type-curated"
