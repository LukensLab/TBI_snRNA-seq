...
de_dir = os.path.join(base_dir, "results", "spreadsheets", "de", "cell_type", "filtered")
input_dir = os.path.join(base_dir, "results", "spreadsheets", "gsea", "CE", "input")
output_dir = os.path.join(base_dir, "results", "spreadsheets", "gsea", "CE", "output")
gsea_save_dir = os.path.join(base_dir, "results", "figures", "go", "CE")
