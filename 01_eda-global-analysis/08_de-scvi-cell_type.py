...
save_dir = os.path.join(base_dir, "results", "spreadsheets", "de-scvi", "cell_type")
fig_dir = os.path.join(base_dir, "results", "figures", "summary", "scvi", "cell_type")
results_dir = os.path.join(base_dir, "results", "spreadsheets", "de-scvi", "cell_type")
