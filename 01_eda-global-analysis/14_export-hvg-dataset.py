...
# -*- coding: utf-8 -*-
"""
Created on Tue Jul  9 11:43:05 2024
...
data_dir = os.path.join(base_dir, "data", "h5ad")
save_dir = os.path.join(base_dir, "export", "csv", "hvg")
h5ad_out = os.path.join(base_dir, "export", "h5ad")
...
layers_to_export = ['counts', 'log1p', 'normalized', 'scaled', 'scvi_normalized']
...
adata.write_h5ad(os.path.join(h5ad_out, '2024_tbi-snrna-seq-cleaned-hvg.h5ad'))
