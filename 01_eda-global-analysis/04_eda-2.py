...
data_dir = Path("/path/to/project") / "analysis/1/h5ad/eda"
scvi_dir = Path("/path/to/project") / "analysis/1/rivanna/scvi"
output_dir = Path("/path/to/project") / "analysis/1/figures/model_H-annotation"

adata = sc.read_h5ad(data_dir / "model_H.h5ad")

################################################################################################################################

# UMAPs of basic gene expression
...
genes = ['Rbfox3', 'Map2', 'Syn1', 'Slc17a6', 'Slc17a7', 'Gad1', 'Gad2', 
              ...
              'Pdgfrb', 'Rgs5',
              'Pdgfra', 'Cspg4', 'Sox10',
              'Mbp', 'Plp1', 'Mog', 'Itgam', 'Itgax',
              'Htr2c', 'Enpp2', 'Stk39', 'Ttr', 'Cdh1', 'Aqp1', 'Foxj1', 'Krt18', 'Gas6',
              'Vim', 'Col1a2', 'Col1a1', 'Col3a1', 'Acta2', 'Myh11', 'Thy1', 'Col4a1', 'Lama1', 'Lama2', 'Fn1'] 
