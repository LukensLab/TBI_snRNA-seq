...
data_dir = f"{base_dir}/analysis/1/h5ad"
scvi_dir = f"{base_dir}/analysis/1/rivanna/scvi"

model_viz_dir = f"{base_dir}/analysis/1/figures/eda"

h5ad_export_dir = f"{base_dir}/analysis/1/h5ad/eda"
################################################################################################################################
...
os.chdir(Path("/path/to/project") / "analysis/1/figures/eda")
